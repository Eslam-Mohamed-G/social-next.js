...
const Recommendations = () => {
    return (
        <div className='flex flex-col gap-4 p-4 rounded-2xl border-1 border-textGrayLight dark:border-borderGray'>
            <p className='font-bold text-xl dark:text-textGrayLight'>Who to follow</p>
            {/* user card */}
            <div className=''>
            ...
            <Link href="/" className='text-iconBlue capitalize'>
                show more
            </Link>
        </div>
    );
